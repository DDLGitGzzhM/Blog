...
6. 按照一次 `0.43u` 的磨损来看，我`2u`可以亏损 5 次，即`512 * 4` = `2560` ，这样子会把 `x` 大成为 3，即我9天内就可以赶上. 总共损耗 `18u`
7. 如果采用限价单双倍的策略,我很容易吃到 `4096` 那么我 `6.75` 天就可以吃满 . 总共损耗 `14u`

![img_1731.png](IMG_1731.png)![img_1732.png](IMG_1732.png)![img_1733.png](IMG_1733.png)
